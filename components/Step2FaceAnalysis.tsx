...
const Step2FaceAnalysis: React.FC<Step2Props> = ({
  ...
  return (
    <div className="animate-fade-in-up h-full flex flex-col w-full">
        <div className="flex-grow overflow-y-hidden pr-2 -mr-2">
              ...
              <div className="lg:col-span-1 flex flex-col gap-4">
                <div className="flex items-start gap-4">
                   ...
                   <div className="flex flex-col gap-2">
                      <label htmlFor="face-image-upload-2" className="flex flex-col items-center justify-center w-16 h-16 bg-slate-100 rounded-lg border-2 border-dashed border-slate-300 text-slate-500 hover:bg-slate-200 hover:border-blue-400 transition-colors cursor-pointer p-1 text-center">
                      ...
                      <button type="button" onClick={() => setIsCameraOpen(true)} className="flex flex-col items-center justify-center w-16 h-16 bg-slate-100 rounded-lg border-2 border-dashed border-slate-300 text-slate-500 hover:bg-slate-200 hover:border-blue-400 transition-colors cursor-pointer p-1 text-center">
                          <CameraIcon className="w-6 h-6"/>
                          <span className="text-[10px] font-semibold mt-1">Camera</span>
                      </button>
                   </div>
                 </div>
            ...
            <div className="flex flex-col items-center gap-6">
              <div className="w-full max-w-lg flex flex-col gap-4">
                 <div className="flex items-start gap-4">
                   ...
                   <div className="flex flex-col gap-2">
                      <label htmlFor="face-image-upload" className="flex flex-col items-center justify-center w-16 h-16 bg-slate-100 rounded-lg border-2 border-dashed border-slate-300 text-slate-500 hover:bg-slate-200 hover:border-blue-400 transition-colors cursor-pointer p-1 text-center">
                          <UploadCloud className="w-6 h-6"/>
                          <span className="text-[10px] font-semibold mt-1">Upload</span>
              ...
              <div className="w-full max-w-lg">
                <Card className="text-center md:text-left">
                    <p className="text-sm sm:text-base text-slate-600 mb-4">Once you've uploaded your photos, we'll analyze them and highlight any areas of concern right on your images.</p>
