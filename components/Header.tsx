...
const Header: React.FC<HeaderProps> = ({ onReset, onCartClick, cartItemCount, onMenuClick }) => {
  return (
    <header className="w-full mx-auto h-16 p-4 flex items-center justify-between lg:hidden fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-md z-40 border-b border-slate-200">
