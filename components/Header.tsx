  ...
  return (
    <header className="w-full mx-auto h-12 px-3 flex items-center justify-between lg:hidden fixed top-0 left-0 right-0 bg-white z-50 shadow-sm border-b border-slate-200">
      <div className="flex items-center gap-1.5">
        <button onClick={onMenuClick} className="p-1 rounded-full hover:bg-black/10 transition-colors" aria-label="Open menu">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <Button onClick={onCartClick} variant="secondary" size="sm" className="relative !rounded-full !p-1.5">
